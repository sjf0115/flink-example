...
public class Timestamp2Example {
    public static void main(String[] args) throws Exception {
        ...
        // 设置作业名称
        config.setString("pipeline.name", Timestamp2Example.class.getSimpleName());
        ...
        Schema schema = Schema.newBuilder()
                ...
                .build();
        Table sourceTable = tEnv.fromDataStream(sourceStream, schema);
