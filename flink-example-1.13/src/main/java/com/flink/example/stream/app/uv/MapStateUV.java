 ...
 */
public class MapStateUV {
    private static final Logger LOG = LoggerFactory.getLogger(MapStateUV.class);
    ...
    public static class UVFunction extends RichMapFunction<SimpleUserBehavior, Tuple2<Long, Long>> implements CheckpointedFunction {
        private MapState<Long, Long> userMapState;
        ...
        public Tuple2<Long, Long> map(SimpleUserBehavior behavior) throws Exception {
            ...
            userMapState.put(userId, timestamp);


            LOG.info("userId: {}, timestamp: {}", userId, timestamp);
