 ...
 */
public class RestoreStateTTLExample {

    private static final Logger LOG = LoggerFactory.getLogger(RestoreStateTTLExample.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple2<String, Long>> stream = source.map(new MapFunction<String, Tuple2<String, Long>>() {
            ...
            public void open(Configuration parameters) throws Exception {
                ...
                StateTtlConfig ttlConfig = StateTtlConfig
                        .newBuilder(Time.minutes(5)) // 过期时间 5分钟后过期
        ...
        stream.print();
        env.execute("RestoreStateTTLExample");
    }
}