 ...
 * 日期：2021/7/2 下午5:42
 */
public class CustomCountTriggerExample {
    private static final Logger LOG = LoggerFactory.getLogger(CustomCountTriggerExample.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        result.print();
        env.execute("CustomCountTriggerExample");
    }
    ...
    private static class CustomCountTrigger <W extends Window> extends Trigger<Object, W> {
        private Logger LOG = LoggerFactory.getLogger(CustomCountTriggerExample.class);
