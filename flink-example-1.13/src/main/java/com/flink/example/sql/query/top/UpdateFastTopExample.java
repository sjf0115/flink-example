package com.flink.example.sql.query.top;
 ...
 */
public class UpdateFastTopExample {
    public static void main(String[] args) throws Exception {
        ...
        // 设置作业名称
        config.setString("pipeline.name", UpdateFastTopExample.class.getSimpleName());
        ...
        // 执行计算
        Table table = tEnv.sqlQuery("SELECT category, product_id, order_amt, `time`, row_num\n" +
                "FROM (\n" +
                "  SELECT\n" +
        ...
        stream.print();
        env.execute("UpdateFastTopExample");
    }
}