...
/**
 * 功能：Deduplication 保留最后一行策略 -- 事件时间降序
 *          回撤流
 * 作者：SmartSi
 ...
 */
public class DeduplicationLastEventTimeDescExample {
    public static void main(String[] args) throws Exception {
        ...
        // 设置作业名称
        config.setString("pipeline.name", DeduplicationLastEventTimeDescExample.class.getSimpleName());
        ...
        stream.print();
        env.execute("DeduplicationLastEventTimeDescExample");
    }
}
