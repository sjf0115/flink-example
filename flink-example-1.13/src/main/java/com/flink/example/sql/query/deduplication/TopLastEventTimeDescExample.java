...
/**
 * 功能：Top 保留最后一行 排序字段不是时间属性字段会降级为 Top 算子
 *      排序字段从 ts_ltz 改为 timestamp 字段(非时间属性字段)
 * 作者：SmartSi
 * CSDN博客：https://smartsi.blog.csdn.net/
 * 公众号：大数据生态
 * 日期：2025/08/12 下午9:20
 */
public class TopLastEventTimeDescExample {
    public static void main(String[] args) throws Exception {
        ...
        // 设置作业名称
        config.setString("pipeline.name", TopLastEventTimeDescExample.class.getSimpleName());
        ...
        stream.print();
        env.execute("TopLastEventTimeDescExample");
    }
}
