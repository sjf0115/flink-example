package com.flink.example.sql.query.over;
 ...
 */
public class RowsOverWindowEventTimeExample {
    public static void main(String[] args) {
        ...
        // 设置作业名称
        config.setString("pipeline.name", RowsOverWindowEventTimeExample.class.getSimpleName());
