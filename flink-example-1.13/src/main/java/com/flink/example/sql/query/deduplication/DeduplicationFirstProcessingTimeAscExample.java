 ...
 */
public class DeduplicationFirstProcessingTimeAscExample {
    public static void main(String[] args) throws Exception {
        ...
        // 设置作业名称
        config.setString("pipeline.name", DeduplicationFirstProcessingTimeAscExample.class.getSimpleName());
        ...
        stream.print();
        env.execute("DeduplicationFirstProcessingTimeAscExample");
    }
}
