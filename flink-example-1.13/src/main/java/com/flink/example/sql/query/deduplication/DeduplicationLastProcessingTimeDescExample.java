...
/**
 * 功能：Deduplication 保留最后一行策略 -- 处理时间降序
 *          回撤流
 * 作者：SmartSi
 ...
 */
public class DeduplicationLastProcessingTimeDescExample {
    public static void main(String[] args) throws Exception {
        ...
        // 设置作业名称
        config.setString("pipeline.name", DeduplicationLastProcessingTimeDescExample.class.getSimpleName());
        ...
        // 注册表
        tEnv.createTemporaryView("shop_sales", sourceStream,
                $("productId").as("product_id"), $("category"),  $("price"),  $("timestamp"), $("proc_time").proctime()
        );
        ...
        stream.print();
        env.execute("DeduplicationLastProcessingTimeDescExample");
    }
}
