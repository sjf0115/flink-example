 ...
 */
public class RetractTopSQLExample {
    public static void main(String[] args) {
        ...
        // 设置作业名称
        config.setString("pipeline.name", RetractTopSQLExample.class.getSimpleName());
        ...
        tEnv.executeSql("CREATE TABLE shop_category_order_top (\n" +
                "  category STRING COMMENT '商品类目',\n" +
                "  product_id BIGINT COMMENT '商品Id',\n" +
                "  order_amt BIGINT COMMENT '商品金额',\n" +
                "  `time` STRING COMMENT '最近下单时间',\n" +
